...
If you find a bug, please open an issue on [GitHub Issues](https://github.com/Marlinekhavele/CodeBEGen/issues) and include as much detail as possible. Provide steps to reproduce, expected and actual behavior, and any relevant logs.
 
### Suggesting Features
 
If you have an idea for a new feature, please open an issue on [GitHub Issues](https://github.com/Marlinekhavele/CodeBEGen/issues) and describe your proposal. Explain why the feature would be useful and how it should work.
...
1. Create a new branch for your work:
   ```sh
   git checkout -b feat/CGBe-2145-your-feature-name
   ```
   ##### Branch Naming Rules
   ...
   - For any of these updates, you will likely use a ticket or an issue. The ticket number, e.g. BIM-2145 or issue number should also be included in your branch name
   - Finally, a short description for your update should follow suit. This is often taken from the ticket title
   - All of this (except the ticket number acronym, `CGBe`) should be written in lowercase
    > Thus, a typical branch should look like `feat/BIM-1234-create-login-page` or like `chore/remove-unused-variables` if your update has no corresponding ticket or issue (unlikely)
2. Make your changes, and commit them with descriptive messages:
   ...
   Commit messages also follow a similar pattern. However, there is no need to add ticket number since they can be easily tracked given the branch name. Instead, use a colon, `:`, after the type of change (`feat`, `fix`, etc.), a whitespace, then your commit message. In cases where you are required to add the ticket number, you may use a the parenthesis after the type of change, like `feat(CGBe-1234): your commit message`
 
   > Another example: `refactor: use a single state for formData` or `refactor(CGBe-1234): use a single state for formData`
