...
class CodeGenerationRequest(BaseModel):
    ...
    method: Optional[str] = Field(
        None, description="HTTP method for endpoint generation"
    )
    endpoint_path: Optional[str] = Field(
        None, description="Path for endpoint generation"
    )
...
class GenerationResult(BaseModel):
    ...
    endpoint: Optional[GeneratedArtifact] = Field(
        None, description="Generated endpoint code"
    )
    model: Optional[GeneratedArtifact] = Field(None, description="Generated model code")
    schema: Optional[GeneratedArtifact] = Field(
        None, description="Generated schema code"
    )
    helpers: Optional[GeneratedArtifact] = Field(
        None, description="Generated helper functions"
    )

    # Metadata
    entity_name: Optional[str] = Field(
        None, description="Detected or specified entity name"
    )
    detected_database_usage: Optional[bool] = Field(
        None, description="Whether database usage was detected"
    )
...
class CodeGenerationResponse(BaseModel):
    ...
    result: Optional[GenerationResult] = Field(
        None, description="Generated code result"
    )
