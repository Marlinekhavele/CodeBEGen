...
class LangchainService:
    ...
    def get_llm(streaming: bool = False, callbacks: Optional[List[Callable]] = None):
        ...
        api_key = getattr(settings, "ANTHROPIC_API_KEY", None) or os.getenv("ANTHROPIC_KEY")
    ...
    @staticmethod
    def create_chain_from_template(template_string: str, streaming: bool = False, callbacks: Optional[List[Callable]] = None):
    ...
    async def generate_endpoint(
        ...
        try:
            ...
            logger.error(f"Error generating endpoint with Langchain: {str(e)}", exc_info=True)
    ...
    async def generate_model(
        ...
        try:
            ...
            logger.error(f"Error generating model with Langchain: {str(e)}", exc_info=True)
    ...
    async def generate_schema(
        ...
        try:
            ...
            logger.error(f"Error generating schema with Langchain: {str(e)}", exc_info=True)
    ...
    async def generate_migration(
        ...
        try:
            ...
            try:
                ...
                logger.warning(f"Could not determine latest migration ID: {str(e)}. Using 'base' as default.")
            ...
            logger.error(f"Error generating migration with Langchain: {str(e)}", exc_info=True)
    ...
    async def generate_helpers(
        ...
        try:
            ...
            logger.error(f"Error generating helper functions with Langchain: {str(e)}", exc_info=True)
            raise Exception(f"Failed to generate helper functions with Langchain: {str(e)}")