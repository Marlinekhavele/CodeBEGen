...
class Settings(BaseSettings):
    ...
    ACCESS_TOKEN_EXPIRE_MINUTES: int = config("ACCESS_TOKEN_EXPIRE_MINUTES", default=15, cast=int)
    JWT_REFRESH_EXPIRY_DAYS: int = config("JWT_REFRESH_EXPIRY_DAYS", default=7, cast=int)
    ...
    DEFAULT_LLM_PROVIDER: str = config("DEFAULT_LLM_PROVIDER", default="anthropic/claude-3-sonnet-20240229")
    ...
    CONFIRM_PROJECT_DELETE_TOKEN: str = config("CONFIRM_PROJECT_DELETE_TOKEN", default="CONFIRM_DELETE")
